...
export default function Home() {
  ...
  return (
    <div className="px-11 py-9 min-h-screen">
      ...
      <div className="mt-4">
        <ButtonMain name={"Buat brand kit"} onClick={() => alert("a")} />
      </div>
    </div>
  );
}
